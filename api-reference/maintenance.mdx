...
| 401 | Unauthorized — no valid session |
| 403 | Forbidden — the authenticated user does not own the requested instance |
| 500 | Failed to start the service |
| 503 | Managed runtime controls are disabled |
...
| 401 | Unauthorized — no valid session |
| 403 | Forbidden — the authenticated user does not own the requested instance |
| 500 | Failed to stop the service |
| 503 | Managed runtime controls are disabled |
...
| 401 | Unauthorized — no valid session |
| 403 | Forbidden — the authenticated user does not own the requested instance |
| 500 | Failed to restart the service |
| 503 | Managed runtime controls are disabled |
...
| 401 | Unauthorized — no valid session |
| 403 | Forbidden — the authenticated user does not own the requested instance |
| 500 | Failed to repair the service |
| 503 | Managed runtime controls are disabled |
