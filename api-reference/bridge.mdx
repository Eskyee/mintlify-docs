...
| `priority` | string | No | Message priority. One of `normal`, `urgent`, `fyi`. Defaults to `normal`. |
...
| `message.priority` | string | Message priority level (`normal`, `urgent`, or `fyi`) |
...
| `priority` | string | Message priority level (`normal`, `urgent`, or `fyi`) |
