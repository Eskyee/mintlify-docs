...
<Info>The live, user-facing endpoints on this page are `GET /api/dashboard/cost` and `GET /api/dashboard/stats`. The lower query endpoints are roadmap/spec documentation only and are not linked from the main navigation.</Info>
