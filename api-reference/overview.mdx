...
| `/api/chat` | POST | Send message to agent via gateway WebSocket proxy |
| `/api/gateway/chat` | POST | Send message to agent via gateway chat proxy (dynamic token retrieval) |
