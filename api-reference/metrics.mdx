...
Requires session authentication. Returns platform-wide metrics including agent counts, message volumes, deployment stats, uptime, performance, and storage usage.
