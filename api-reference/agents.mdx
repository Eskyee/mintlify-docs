...
| Field | Type | Description |
|-------|------|-------------|
| `image` | string | New service image. The platform default is `ghcr.io/openclaw/openclaw:2026.4.1`. |
...
| 403 | Both | Forbidden — authenticated user does not own this agent instance |
