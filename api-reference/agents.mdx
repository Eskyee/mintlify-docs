...
```json
{
  ...
  "previousImage": "ghcr.io/openclaw/openclaw:2026.3.28",
...
| `openclawVersion` | string | OpenClaw runtime version from the backend, or `2026.3.31` as fallback |
...
| `openclawVersion` | string | Hardcoded OpenClaw runtime version (`2026.3.28`). Only present when the gateway is healthy. |
