...
<Warning>`GET /api/agents/:id/config` is deprecated. This endpoint is not currently implemented and may be removed in a future release.</Warning>

## Update agent configuration

<Warning>`PUT /api/agents/:id/config` is deprecated. This endpoint is not currently implemented and may be removed in a future release.</Warning>
...
<Warning>`GET /api/agents/:id/messages` is deprecated. This endpoint is not currently implemented and may be removed in a future release.</Warning>
