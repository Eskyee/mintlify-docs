...
```json
{
  "success": true,
  "userId": "a1b2c3d4e5",
  "url": "https://agentbot-agent-a1b2c3d4e5.up.railway.app",
  "status": "deploying"
}
```
...
| `url` | string | The Railway service URL for the agent (format: `https://agentbot-agent-{agentId}.up.railway.app`) |
