  ...
  "agents": [
    {
      ...
      "status": "running",
      "url": "https://agentbot-agent-user123_pm.up.railway.app"
    },
    {
      "container": "team_1711234567890_a1b2c3/engineer",
      "status": "running",
      "url": "https://agentbot-agent-user123_engineer.up.railway.app"
    },
    {
      "container": "team_1711234567890_a1b2c3/qa",
      "status": "running",
      "url": "https://agentbot-agent-user123_qa.up.railway.app"
    }
  ],
...
| `agents[].url` | string | Agent service URL. The format depends on the provisioning path used. When Railway generates a public domain, the URL is assigned by Railway and may not follow a predictable pattern. |
