...
Manage user authentication, password resets, Farcaster identity, and token gating.
...
| Code | Description |
|------|-------------|
| 400 | Token and password are required, password too short, or invalid/expired token |
| 404 | User not found |
| 429 | Too many requests |
