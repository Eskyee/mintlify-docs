...
<Warning>Google OAuth sign-in has been deprecated and is no longer available. Use email/password authentication via [`POST /api/auth/login`](#sign-in) or wallet sign-in instead.</Warning>
