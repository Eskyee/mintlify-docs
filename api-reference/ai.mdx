...
|------|-------|--------|-------------|-------------|------------------|
| `solo` | £29/mo | `openai/gpt-4o-mini`, `google/gemini-2.0-flash` | 1 | 3 | 100 |
| `collective` | £69/mo | `openai/gpt-4o-mini`, `openai/gpt-4o`, `google/gemini-2.0-flash`, `anthropic/claude-3.5-sonnet` | 3 | 10 | 500 |
| `label` | £149/mo | `openai/gpt-4o-mini`, `openai/gpt-4o`, `openai/gpt-4-turbo`, `google/gemini-2.0-flash`, `anthropic/claude-3.5-sonnet`, `anthropic/claude-3-opus` | 10 | 25 | 2,000 |
