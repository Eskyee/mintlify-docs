...
<Note>These endpoints are internal backend endpoints and are not exposed through the web application's `/api` routes. The chat endpoint requires a valid subscription plan; other endpoints in this group do not require authentication.</Note>
