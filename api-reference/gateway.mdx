...
| `terminalSessions` | number | Number of active WebSocket terminal sessions |
...
- **`/ws/terminal`** — Routed to the built-in terminal WebSocket service, which provides an interactive terminal session to the container.
