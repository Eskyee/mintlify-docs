...
Solana addresses are supported as payment recipients in the `pay` action. Provide a valid Base58-encoded Solana address (32–44 characters) in the `recipient` field.
