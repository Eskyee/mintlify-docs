...
|------|-------|-------|--------------|
| Underground | £29/mo | 1 Agent · Mistral 7B | Telegram, BYOK, A2A Bus Access, Basic Analytics |
| Collective | £69/mo | 3 Agents · Llama 3.3 | Everything in Underground + Royalty Split Engine, Mission Control Graph, WhatsApp, Priority support |
...
<Note>The billing page displays the Underground, Collective, and Label plans as upgrade options. The Network plan is available by contacting sales.</Note>
...
<Note>The `plan` parameter uses internal plan IDs. The billing page maps these to display names: `solo` is shown as "Underground", `collective` as "Collective", and `label` as "Label".</Note>
