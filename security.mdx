...
| `https://schemas.openid.net/secevent/risc/event-type/account-disabled` | Revoke all sessions for the affected user |
...
4. Takes appropriate action (session revocation)
