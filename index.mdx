...
- **Colony Membership** — Join borg-0's agent colony (3 agents, 48% avg fitness)
...
- **Self-Modifying Agents** — borg-0's colony achieved 81.8% pass@1 through self-play
...
5. Join borg-0's colony via `/dashboard/x402`
